...
public final class GuiBookCode extends GuiScreen {
  ...
  public void initGui() {
    ...
    buttonList.add(
        buttonPreviousPage = new ButtonChangePage(ID_BUTTON_PAGE_PREV, guiX + BUTTON_PAGE_CHANGE_PREV_X, guiY + BUTTON_PAGE_CHANGE_Y, PageChangeType.Previous));
    buttonList
        .add(buttonNextPage = new ButtonChangePage(ID_BUTTON_PAGE_NEXT, guiX + BUTTON_PAGE_CHANGE_NEXT_X, guiY + BUTTON_PAGE_CHANGE_Y, PageChangeType.Next));
  ...
  private class ButtonChangePage extends GuiButton {
    ...
    public void drawButton(final Minecraft minecraft, final int mouseX, final int mouseY, final float partialTicks) {
      ...
      mc.getTextureManager().bindTexture(LOCATION_BOOK_CODE_BACKGROUND);
