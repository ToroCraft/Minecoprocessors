...
public class BlockMinecoprocessor extends BlockRedstoneDiode implements ITileEntityProvider, IMetaBlockName {
	...
	public static ItemBlockMeta ITEM_INSTANCE;
	//public static ItemBlockMeta ITEM_OVERCLOCKED_INSTANCE;
	...
	public static void initItem(final RegistryEvent.Register<Item> event) {
		ITEM_INSTANCE = new ItemBlockMeta(INSTANCE);
		ITEM_INSTANCE.setRegistryName(REGISTRY_NAME);
		event.getRegistry().register(ITEM_INSTANCE);

//		ITEM_OVERCLOCKED_INSTANCE = new ItemBlockMeta(INSTANCE);
//		ITEM_OVERCLOCKED_INSTANCE.setRegistryName(REGISTRY_OVERCLOCKED_NAME);
//		event.getRegistry().register(ITEM_OVERCLOCKED_INSTANCE);
	}

	public static void registerRenders() {
		ModelResourceLocation model = new ModelResourceLocation(Minecoprocessors.MODID + ":" + NAME, "inventory");
		ModelResourceLocation modelOverclocked = new ModelResourceLocation(Minecoprocessors.MODID + ":" + NAME, "overpowered=true");
		//ModelResourceLocation modelOverclocked = new ModelResourceLocation(Minecoprocessors.MODID + ":" + NAME + "_overclocked", "inventory");

		//variantName + "=" + value.getName()
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(ITEM_INSTANCE, 0, model);
		//Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(ITEM_INSTANCE, 4, modelOverclocked);

		ModelLoader.setCustomModelResourceLocation(ITEM_INSTANCE, 4, modelOverclocked);
	}

	@Override
	public int damageDropped(IBlockState state) {
		return super.damageDropped(state);
		// TODO implement this for overclocked
	}
	...
	public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta,
		...
		//this.getStateFromMeta(meta).withProperty(LOG_AXIS, BlockLog.EnumAxis.fromFacingAxis(facing.getAxis()));

		System.out.println("getStateForPlacement: " + meta);
	...
	public IBlockState getStateFromMeta(int meta) {
		...
		System.out.println("getStateFromMeta(" + meta + ")->" + state);
	...
	public String getSpecialName(ItemStack stack) {
		return getLocalizedName() + "_" + stack.getItemDamage();
	}
}
